...
try {
    ...
    $mail->addAddress($RecipientAdd);    // #Name is optional//收件人Email
    ...
    $mail->Subject = '感恩牆劃位成功';//#郵件標題
    $mail->Body    = $letter;//#郵件內容...This is the HTML message body <b>in bold!</b>
    $mail->AltBody = $letter;//#附加內容...This is the body in plain text for non-HTML mail clients
