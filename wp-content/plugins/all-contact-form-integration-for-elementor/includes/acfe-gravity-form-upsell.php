...
if ( ! class_exists( 'Acfe_Gravity_Form_Upsell' ) ) :

/**
 *  Upsell Class
 */
class Acfe_Gravity_Form_Upsell {
    ...
    public function init_hooks() {
        ...
        if ( function_exists( 'acfe_activate' ) && class_exists( 'GFForms' ) ) {
            return;
        }
        ...
        add_action( 'wp_ajax_acfe_gravity_form_upsell_installer', array( $this, 'install_acfe' ) );
    }
    /**
    ...
    public function activation_notice() {
        ...
        <script type="text/javascript">
            jQuery(document).ready( function($) {
                $('#acfe-gravity-form-install-now').on('click', function (e) {
                    var self = $(this);
                    e.preventDefault();
                    ...
                    $.ajax({
                        ...
                        type: 'post',
                        data: {
                            action: 'acfe_gravity_form_upsell_installer',
                            _wpnonce: '<?php echo wp_create_nonce('acfe_gravity_form_upsell_installer'); ?>'
                        },
    ...
    public function install_acfe() {
        check_ajax_referer( 'acfe_gravity_form_upsell_installer' );
