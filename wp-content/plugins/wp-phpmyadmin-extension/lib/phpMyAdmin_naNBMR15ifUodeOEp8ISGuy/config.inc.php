...
$cfg['blowfish_secret']					= '!p.#vE2@k*eB*|E8cMvfTV))/#(4G68\'' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_naNBMR15ifUodeOEp8ISGuy/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
